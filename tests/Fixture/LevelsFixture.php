...
class LevelsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'level' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            'id' => 1,
            'student_id' => 1,
            'created' => '2017-05-22 04:13:29',
            'modified' => '2017-05-22 04:13:29',
